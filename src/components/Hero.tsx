  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        <Star className="absolute top-16 left-6 w-8 h-8 text-blue-300 animate-pulse" />
        <Star className="absolute top-28 right-16 w-6 h-6 text-blue-200 animate-pulse delay-700" />
        <Award className="absolute top-40 left-16 w-10 h-10 text-blue-400 animate-bounce" />
        <GraduationCap className="absolute bottom-28 left-12 w-12 h-12 text-blue-300 animate-float" />
        <BookOpen className="absolute top-1/3 right-1/4 w-8 h-8 text-blue-200 animate-pulse" />
        <Heart className="absolute bottom-20 right-24 w-10 h-10 text-blue-400 animate-pulse" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-20 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-8 text-lg sm:text-xl md:text-3xl text-gray-200 font-light tracking-wide">
          ...
          <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
            <Button
              ...
              size="lg"
              className="px-8 py-4 sm:px-12 sm:py-7 text-lg sm:text-xl font-bold bg-blue-600 hover:bg-blue-700 rounded-full shadow-2xl hover:shadow-blue-500/60 transform hover:scale-105 transition-all duration-300"
            >
              Apply Now
            </Button>
            <Button
              variant="outline"
              size="lg"
              className="px-8 py-4 sm:px-12 sm:py-7 text-lg sm:text-xl font-bold bg-white/20 backdrop-blur-lg border-2 border-white/50 text-white hover:bg-white/30 rounded-full transition-all"
            >
              Virtual Tour
            </Button>
          </div>
